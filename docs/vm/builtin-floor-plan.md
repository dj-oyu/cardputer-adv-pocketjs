...
### 18.3 実機（実測(device)、2026-09-27、`js=` ソース評価後）

| アプリ | F3b まで（§17.3） | F3c 後 | 差 | F 系列の前（§12.4）からの差 |
| --- | --- | --- | --- | --- |
| hello | 42,752 | 38,248 | −4,504 | −47,740（−56%） |
| imucal | 56,612 | 52,096 | −4,516 | −48,612（−48%） |
| pet | 59,928 | 55,408 | −4,520 | −50,756（−48%） |
| companion | 53,892 | 49,292 | −4,600 | −49,104（−50%） |
| Kasane デモ | 57,356 | 52,496 | −4,860 | — |

ゲスト作成直後の `js=` は 32,580 → 28,112。既定の設定で `smoke_device.py --cycles 20`・故障回復 6 種・
