...
// never grow past what it was before this change (docs/vm-L2-design.md
...
// eat into the same headroom (docs/vm-L2-design.md sec.10.8 measured 6,240 B
...
typedef struct JSVMSeg {
    ...
    // payload saves (docs/vm-L2-design.md sec.13.3, calculated).
    int standard;
} JSVMSeg;
