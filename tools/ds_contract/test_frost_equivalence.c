...
#include <stdio.h>
#include <string.h>
void reference_init(ds_frost *);
ds_result reference_feed(ds_frost *,uint16_t,uint16_t,const uint16_t *);
ds_result reference_blur(ds_frost *,uint8_t);
ds_result reference_span(const ds_frost *,uint16_t,uint16_t,uint16_t,ds_rgba,uint16_t *);
