...
FAULTS = {
    ...
    "binding-enumerable": ("#define LAZY_TA(name, cid) { name, JS_PROP_WRITABLE | JS_PROP_CONFIGURABLE,",
                           "#define LAZY_TA(name, cid) { name, JS_PROP_WRITABLE | JS_PROP_CONFIGURABLE | JS_PROP_ENUMERABLE,"),
}
