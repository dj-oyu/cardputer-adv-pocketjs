...
gcc -std=gnu11 ${CFLAGS:--O1 -g -fsanitize=address,undefined} -Wall -Wextra -Werror \
  ...
  main/pocket/app_view_assets.c main/pocket/app_view_provider.c main/pocket/app_music_view.c main/pocket/app_legacy_presenter.c main/pocket/pocket_kasane.c main/ui/kasane/ksn_runtime.c main/ui/kasane/ksn_schema.c main/ui/kasane/ksn_schema_session.c main/ui/kasane/ksn_core.c main/ui/kasane/ksn_view.c \
