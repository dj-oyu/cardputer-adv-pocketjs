...
*/
/* VMALLOC PATCH: not part of upstream estalloc (pinned dd3988acb10a). One
 * counter per est_malloc() call, incremented once per free-block visited
