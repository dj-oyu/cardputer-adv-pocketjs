// USB diagnostic z. One producer field drives two independent text nodes.
(function () {
  const view = pocket.kasane.mount({version: 1,
    ...
    nodes: [
      {type: 'rect', bounds: [0, 0, 192, 24], color: 0x060c1aff},
      {type: 'text', bounds: [4, 4, 92, 16], text: {slot: 'elapsed'}, color: 0xe2f0ffff},
      {type: 'text', bounds: [100, 4, 188, 16], text: {slot: 'elapsed'}, color: 0xe2f0ffff}
