#ifndef DS_FROST_KERNEL_H
#define DS_FROST_KERNEL_H
#include "ds_frost.h"
#ifdef ESP_PLATFORM
#include "sdkconfig.h"
#endif
#if defined(CONFIG_IDF_TARGET_ESP32S3) || defined(DS_FROST_PIE_MODEL)
#define DS_FROST_VECTOR 1
...
static void ds_frost_cell_pie(uint16_t *dst,const uint16_t *k){
