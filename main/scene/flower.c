...
// sixteen. See docs/perf/pie-simd.md 3.7.
//
...
static void prepare_seeds(void) {
    ...
    for(int i=0;i<LAT;i++) {
        ...
        // call into a ROM routine (docs/perf/pie-simd.md 3.7). Six bands, twice
...
static bool bell_hit(const Petal *p,float dx,const float *ob,float *best,V *norm) {
    ...
    for(int band=0;band<LAT;band++) {
        ...
        // docs/perf/pie-simd.md 3.7 for it is an estimate -- and this is the first
